...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`the mobile store v1`}</title>

        <meta
          name="description"
          content="Welcome to the Mobile Store v1, your ultimate solution for efficient and seamless mobile store inventory management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1580974928064-f0aeef70895a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBzdG9yZXxlbnwwfHx8fDE2OTUzNzU0MDV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@hugoagut?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Hugo Agut tugal`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to the Mobile Store v1, your ultimate solution for efficient and seamless mobile store inventory management.`}
            </Text>
            <Box
