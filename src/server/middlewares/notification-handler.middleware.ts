...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['owner', 'manager', 'employee', 'supplier'],
    key: 'orderId',
    tenantPath: [],
    userPath: [],
  },
  ...
  'PaymentReceived.create': { roles: ['owner', 'manager', 'employee'], key: 'paymentId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'manager', 'employee', 'supplier', 'customer'];
